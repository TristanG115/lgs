...
import { registerResearchTools, type FileResearchRequirementStore, type FileResearchStore, type ResearchCycleEngine, type ResearchService } from '../research/index.js';
...
import { ContextBroker, registerContextTools, type ContextLifecycleManager } from '../context/index.js';
...
export function createWorkspaceToolRegistry(options: { gitBaseline?: GitBaseline; gitRunner?: GitCommandRunner; verificationRunner?: VerificationRunner; executionLogs?: RawExecutionLogStore; completionGuard?: CompletionGuard; completionEvidence?: FileCompletionEvidenceStore; orchestrator?: Orchestrator; managerAgentId?: string; taskState?: FileTaskStateStore; watchdog?: WatchdogService; research?: ResearchService; researchStore?: FileResearchStore; researchCycles?: ResearchCycleEngine; researchRequirements?: FileResearchRequirementStore; documentationAgent?: DocumentationAgent; documentationStore?: FileDocumentationAuditStore; independentReviewer?: IndependentReviewer; reviewStore?: FileReviewStore; processes?: ManagedProcessManager; runtimeVerifier?: RuntimeVerifier; runtimeStore?: FileRuntimeStore; commitService?: VerifiedCommitService; skills?: WorkspaceSkillStore; memories?: ProjectMemoryStore; integrations?: IntegrationHub; usage?: UsageTracker; pricing?: FilePricingStore; computer?: ComputerAgent; editing?: FileEditService; contextLifecycle?: ContextLifecycleManager } = {}): ToolRegistry {
  ...
  if (options.research && options.researchStore) registerResearchTools(registry, options.research, options.researchStore, options.researchCycles, options.researchRequirements);
  ...
  if (options.gitBaseline) registerContextTools(registry, new ContextBroker(), options.contextLifecycle);
